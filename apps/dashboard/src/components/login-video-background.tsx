...
export function LoginVideoBackground() {
  ...
  return (
    <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden m-2">
      ...
      >
        <img
          src="https://cashpanel.io/cdn-cgi/image/width=1000,quality=80,format=auto/https://cdn.cashpanel.io/video-poster-v2.jpg"
          alt=""
      ...
      <video
        ...
        playsInline
        preload="auto"
        poster="https://cashpanel.io/cdn-cgi/image/width=1000,quality=80,format=auto/https://cdn.cashpanel.io/video-poster-v2.jpg"
      >
        <source
