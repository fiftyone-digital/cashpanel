...
Customers in CashPanel store the information you need for invoicing and tracking work.

## Add a customer

1. Go to [Customers](https://app.cashpanel.io/customers)
...
CashPanel can automatically enrich customer profiles:
