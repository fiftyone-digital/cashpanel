...
description: Get your OAuth app verified and listed in the CashPanel app directory.
section: developer
order: 5
---

Once your OAuth app is working, you can submit it for review. Verified apps display a trust badge and can be listed in the CashPanel app directory for users to discover.

## Why get verified?

### For users

- **Trust badge**: Verified apps show users that CashPanel has reviewed the app
...
- **App directory listing**: Reach CashPanel's user base
- **Partnership opportunities**: Connect with the CashPanel team
...
- Apps work fully
- Users see a warning: "This app hasn't been verified by CashPanel yet"
...
- [ ] App works with different CashPanel accounts
...
After approval, you can opt to list your app in the CashPanel app directory:
...
- Don't include "CashPanel" unless you have permission
- Avoid misleading names that imply official CashPanel features
...
- **Discord**: [go.cashpanel.io/discord](https://go.cashpanel.io/discord)
