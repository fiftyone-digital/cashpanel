...
The CashPanel MCP server gives AI tools like Claude, Cursor, ChatGPT, and Raycast full access to your business data — not just reading, but creating invoices, managing transactions, tracking time, and exporting to your accountant.

## What is MCP?

Model Context Protocol (MCP) is an open standard for connecting AI assistants to external data sources. Instead of copying and pasting data, MCP lets AI tools work with your CashPanel account directly and securely.

## Supported tools

CashPanel MCP works with:
...
Add CashPanel to your Claude Desktop configuration.
...
```json
{
  "mcpServers": {
    "cashpanel": {
      "command": "npx",
      "args": ["-y", "@cashpanel-ai/mcp"],
      "env": {
        "CASHPANEL_API_KEY": "your-api-key-here"
      }
    }
  }
}
...
After saving, restart Claude Desktop. You should see CashPanel in your available tools.
...
Use CashPanel data while coding in Cursor.
...
Use CashPanel with ChatGPT via custom GPTs or plugins.

### Custom GPT approach

1. Create a Custom GPT in ChatGPT
2. Add actions that call the CashPanel API
3. Configure authentication with your API key

### Configuration

Use the CashPanel API endpoints with your API key in the Authorization header:
...
Access CashPanel from Raycast on Mac.

### Install the extension

1. Open Raycast
2. Search for "CashPanel" in the Store
3. Install the extension

### Configure

1. Open Raycast preferences
2. Find the CashPanel extension
3. Enter your API key

### Use it

Trigger Raycast and use CashPanel commands to query your financial data.
...
>
> **Assistant**: Based on your CashPanel data:
> - Cash balance: $45,230
...
- Try running `npx @cashpanel-ai/mcp` manually to test
