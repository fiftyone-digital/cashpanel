...
Most bank exports work directly. CashPanel maps common formats automatically.
...
4. Map columns to CashPanel fields
5. Review the preview
6. Confirm import

## Column mapping

If CashPanel doesn't recognize your columns automatically:

1. Match each CSV column to a CashPanel field
...
- CashPanel checks for duplicates based on date, amount, and description
