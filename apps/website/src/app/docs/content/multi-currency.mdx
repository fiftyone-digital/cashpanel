...
description: How CashPanel handles multiple currencies and exchange rates.
section: banking
order: 7
---

CashPanel supports businesses operating in multiple currencies. Connect accounts in different currencies, track international transactions, and see unified reports in your base currency.
...
1. Go to [Settings → Accounts](https://app.cashpanel.io/settings/accounts)
...
You can connect bank accounts in any currency CashPanel supports.
...
CashPanel uses market exchange rates to convert currencies.
...
CashPanel uses reliable market rates updated daily. Rates are for display purposes and may differ slightly from your bank's rates.
...
For tax purposes, you may need to track original currency amounts. CashPanel stores both the original and converted amounts for every transaction.

## Supported currencies

CashPanel supports all major world currencies including:
