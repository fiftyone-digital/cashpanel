...
Your revenue forecast shows how much money you can expect to receive in the coming months. Unlike simple projections that just extend past trends, CashPanel builds your forecast from real, known sources of incoming revenue.
...
1. Go to [Overview](https://app.cashpanel.io)
...
- **Projected revenue**: What CashPanel expects you'll receive (dashed line)
- **Confidence score**: How reliable the projection is

## How the forecast works

CashPanel calculates your forecast by adding up known and expected revenue sources. This "bottom-up" approach is more accurate than simply assuming past trends will continue.
...
To keep forecasts realistic, CashPanel automatically excludes:
...
The more information CashPanel has, the better your forecast:
...
When you [track billable hours](/docs/track-time-timer), CashPanel can estimate unbilled revenue. Link your tracked time to projects with hourly rates.
...
Set your base currency in [Settings](https://app.cashpanel.io/settings).
...
CashPanel may show warnings on your forecast:
...
**"Limited history"**: Not enough historical data to calculate reliable baselines. Accuracy improves as you use CashPanel longer.
