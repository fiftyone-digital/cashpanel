...
Recurring invoices save time for ongoing client relationships. Set it once, and CashPanel sends invoices automatically.
...
1. Go to [Invoices](https://app.cashpanel.io/invoices) → **Create invoice**
