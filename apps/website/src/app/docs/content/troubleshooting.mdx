...
Quick solutions to common issues you might encounter with CashPanel.
...
1. Check the connection is still active in [Inbox Settings](https://app.cashpanel.io/inbox/settings)
...
1. Verify Stripe is connected in [Invoice Settings](https://app.cashpanel.io/settings/invoice)
...
1. Go to [Settings → Billing](https://app.cashpanel.io/settings/billing)
...
1. **Email**: [support@cashpanel.io](mailto:support@cashpanel.io)
