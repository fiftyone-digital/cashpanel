...
We're excited to release CashPanel v1.1—our biggest update yet! This release brings intelligent tax automation, a native desktop app, public APIs, and dozens of improvements that make managing your business finances faster and more intuitive than ever.

<br />
![Tax assistant](https://cdn.cashpanel.io/blog/v1.1/tax-assistant.png)

#### Tax assistant
<br />
Say goodbye to manual tax calculations. CashPanel now automatically extracts tax rates and types from your uploaded receipts and applies them to transactions, making reconciliation fast and accurate. Plus, get instant tax insights with our AI assistant:
...
<br />
![Desktop app](https://cdn.cashpanel.io/blog/v1.1/desktop.png)
<br />
#### Desktop app

CashPanel is now just one keystroke away with our new native desktop app. Access your financial data instantly and search across your entire business.

- **Instant access:** Launch CashPanel with a simple keyboard shortcut from anywhere on your computer—no more hunting through browser tabs
...
- **Always at your fingertips:** Whether you're in a meeting, on a call, or working in another app, CashPanel is ready when you need it
- **Native speed:** Everything feels snappier and more responsive than the web version, making your daily workflow smoother

<br />
![Search](https://cdn.cashpanel.io/blog/v1.1/sdk.png)
<br />
#### APIs and SDKs

Build your own integrations and automate your workflows with CashPanel's new public API and SDKs. Connect CashPanel to your existing tools, create custom dashboards, or automate repetitive tasks.

- **RESTful API:** Access your CashPanel data securely and reliably at [api.cashpanel.io](https://api.cashpanel.io)
- **Multiple SDKs:** Available for JavaScript/TypeScript, Python, Ruby, Go, and PHP
- **Easy setup:** Generate your API key from the [API Keys section](https://app.cashpanel.io/settings/developer) in your dashboard settings
- **Extensible platform:** Soon you'll be able to contribute apps and functionality through our Apps & Integrations platform

<br />
#### Stability & Performance
<br />
We've upgraded our infrastructure, added replicas in the US, and reworked how we read and write data under the hood. As a result, CashPanel is now ~70% faster in the US. These changes lay the foundation for an even better experience, especially with the upcoming Assistant and Mobile App.
...
We're already working on the next wave of enhancements to make CashPanel even more indispensable:
...
- **Webhooks:** Get real-time notifications and trigger workflows in your own systems when key events happen in CashPanel
