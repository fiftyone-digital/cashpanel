...
Earlier this week [Dub.co](http://Dub.co) shared our [customer story](https://dub.co/customers/cashpanel) on why we choose Dub as our link-sharing infrastructure.
...
<br />
![CashPanel - Overview](/images/overview.png)

<br />
If you look closely you can se our link looks like this: [https://go.cashpanel.io/5eYKrmV](https://go.cashpanel.io/5eYKrmV)
...
```typescript
const dub = new Dub({ projectSlug: "cashpanel" });
...
<br />
You can find the source code for this in our repository [here](https://github.com/fiftyone-digital/cashpanel/tree/main/apps/dashboard/src/actions/report).
