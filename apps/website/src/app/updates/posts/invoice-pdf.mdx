...
summary: "Discover how we're implementing PDF invoice generation in CashPanel, using React-based solutions for customizable, efficient document creation."
...
## Invoice in CashPanel
![PDF Invoices](/images/update/invoice-pdf/invoice.jpg)
<br />
We are building a new experience for invoices in CashPanel. You'll be able to create and send invoices to your customers, as well as generate PDFs for each invoice.
...
The invoice is then generated and saved to your [Vault](https://cashpanel.io/vault), so we can match it to incoming transactions and mark it as paid.
...
```tsx
import { InvoiceTemplate, renderToStream } from "@cashpanel/invoice";
import { getInvoiceQuery } from "@cashpanel/supabase/queries";
...
You can find the full code for the invoice template [here](https://go.cashpanel.io/inv).
...
const CDN_URL = "https://cdn.cashpanel.io";
