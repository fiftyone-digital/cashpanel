...
```bash
npm install @cashpanel/categories
```
...
```typescript
import { CATEGORIES, getCategoryBySlug, getParentCategory } from '@cashpanel/categories';
...
```typescript
import { getTaxRateForCategory, getTaxTypeForCountry } from '@cashpanel/categories';
...
```typescript
import { getCategoryColor, CATEGORY_COLOR_MAP } from '@cashpanel/categories';
